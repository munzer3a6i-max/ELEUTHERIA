...
import { worker, totalExpenses, totalIncome, netProfit, profitMargin, formatCurrency } from '../../data/workerProfile'
      ...
      <div className="col-span-8 flex items-center gap-5 rounded-lg border border-[#162650] bg-[#0a142f] p-[17px]">
        <div className="flex flex-col items-center">
          <div className="flex size-24 items-center justify-center overflow-hidden rounded-full border-2 border-amber-500/50 bg-slate-800 p-1 shadow-md">
            <div className="flex size-full items-center justify-center rounded-full bg-slate-700">
        ...
        <div className="flex-1">
          <div className="mb-2.5 flex items-center gap-3">
            ...
            <span className="rounded border border-emerald-500/40 bg-emerald-950/80 px-2.5 py-0.5 text-[10px] font-bold text-emerald-400">
              {worker.status}
            </span>
          </div>
            ...
            <MetaRow
              ...
              value={
                <span className="flex items-center gap-1.5">
                  <span className="h-2.5 w-3.5 overflow-hidden border border-slate-500 bg-blue-600">
